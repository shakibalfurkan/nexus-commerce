...
// supplies the Prisma client, the Kafka client/producer, the canonical service
// name, and the event-type → topic resolver. start/stop are re-exported with
// the same names so server.ts is unchanged.
